...
namespace Day3LineComparison
{
    internal class GreaterOrLess
    {
        public static double Compare()
        {
             ...
             Console.WriteLine("Enter the value oy x2");
             ...
             Console.WriteLine("Enter the value oy p2");
            ...
            if (length2 > length1)
            {
                Console.WriteLine("First Line Smaller That Second Line");
            }
